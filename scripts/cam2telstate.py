...
SENSORS = [
    ...
    Sensor('${stream.cbf.baseline_correlation_products}_version', immutable=True, ignore_missing=True),
    Sensor('${stream.cbf.baseline_correlation_products}_source', immutable=True, ignore_missing=True),
    Sensor('${stream.cbf.baseline_correlation_products}_revision', immutable=True, ignore_missing=True),
    ...
    Sensor('${stream.cbf.tied_array_channelised_voltage}_n_chan_range', immutable=True, convert=np.safe_eval),
    Sensor('${stream.cbf.tied_array_channelised_voltage}_dither_seed', immutable=True),
    Sensor('${stream.cbf.tied_array_channelised_voltage}_delay', immutable=True, convert=np.safe_eval),
    ...
    Sensor('${stream.cbf.tied_array_channelised_voltage}_version', immutable=True, ignore_missing=True),
    Sensor('${stream.cbf.tied_array_channelised_voltage}_source', immutable=True, ignore_missing=True),
    Sensor('${stream.cbf.tied_array_channelised_voltage}_revision', immutable=True, ignore_missing=True),
    #
    # Subarray sensors
    #
    ...
    Sensor('${sub_stream.cbf.baseline_correlation_products}_channel_data_suspect',
           convert=convert_bitmask),
    Sensor('${sub_stream.cbf.tied_array_channelised_voltage}_channel_data_suspect',
           convert=convert_bitmask),
